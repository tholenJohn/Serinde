...
var logWrapper = function (prefix) {
    return function () {
        ...
        log.apply(void 0, __spread([prefix], var_args));
    };
};
/**
...
var error = function () {
    ...
    var message = 'FIREBASE INTERNAL ERROR: ' + buildLogMessage_.apply(void 0, __spread(var_args));
...
var fatal = function () {
    ...
    var message = "FIREBASE FATAL ERROR: " + buildLogMessage_.apply(void 0, __spread(var_args));
    logClient.error(message);
...
var warn = function () {
    ...
    var message = 'FIREBASE WARNING: ' + buildLogMessage_.apply(void 0, __spread(var_args));
