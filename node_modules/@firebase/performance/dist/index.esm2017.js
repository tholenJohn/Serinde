...
const ERROR_DESCRIPTION_MAP = {
    ...
    ["invalide custom metric name" /* INVALID_CUSTOM_METRIC_NAME */]: 'Custom metric name {$customMetricName} is invalid'
};
...
serializer) {
    ...
    return (_loggerInstance, _level, ...args) => {
...
function sendTraceLog(trace) {
    if (getIid()) {
        setTimeout(() => getLogger().log(trace, 1 /* Trace */), 0);
    }
}
function logNetworkRequest(networkRequest) {
    ...
    setTimeout(() => getLogger().log(networkRequest, 0 /* NetworkRequest */), 0);
}
